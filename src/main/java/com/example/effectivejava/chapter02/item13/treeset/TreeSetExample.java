...
public class TreeSetExample {
    ...
    public static void main(String[] args) {
        ...
        TreeSet<PhoneNumber> numbers2 = new TreeSet<>(Comparator.comparingInt(PhoneNumber::hashCode));
        Set<PhoneNumber> phoneNumbers = Collections.synchronizedSet(numbers2); //동기화
